const styleConfig = {
  ...
  model: {
    ...
    style: [
      ...
      { name: "multiplier", label: "模型速度", type: "number", min: 1, max: 20, step: 1, defval: 1 },
  ...
  ellipsoid: {
    ...
    style: [
      ...
      { name: "pause", label: "是否暂停", type: "radio", defval: false },
      { name: "step", label: "扫描速度", type: "number", min: 0, max: 1.0, step: 0.01, defval: 0.1 },
